...
" By default you have 1000ms after typing your leader key to type your
" shortcut. That value can be adjusted by setting timeoutlen
set timeoutlen=500
...
nnoremap <leader>e :Fern . -drawer -toggle -width=40 -reveal=%<cr>
...
" ==== START: Buffers ====
" Show list of buffers with fzf.vim
nnoremap <silent> <Leader>ba :Buffers<CR>
...
nnoremap <silent> <tab>k :tabn<CR>
nnoremap <silent> <tab>j :tabp<CR>
nnoremap <silent> <tab>h :tabfirst<CR>
nnoremap <silent> <tab>l :tablast<CR>
nnoremap <silent> <tab>c :tabclose<CR>
" nnoremap <silent> <tab>mf :tabm 0<CR>
" nnoremap <silent> <tab>ml :tabm<CR>
" ==== END: Tabs ====
